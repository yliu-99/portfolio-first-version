function Overview() {
  return (
    ...
    <p>Before shifting into tech and design, I earned a Bachelor’s Degree in Music Performance and also spent two years working as a private voice teacher. These experiences have strengthened my understanding of communication, connection, emotion, and narrative, which I carry into all my creative projects today.
</p>
<p>Outside of school and work, I recharge by making music, spending quality time with loved ones, playing video games, cooking, exploring photography, and crafting things by hand. These little joys help me stay curious, grounded, and inspired in everything I do.
</p>
    </div>
  );
}
