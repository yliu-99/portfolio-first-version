            ...
            <div className="values-grid">
              ...
              >
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <img src="https://i.postimg.cc/5y1jBP3q/yuhan-singing-with-guitar.jpg" alt="Yuhan Singing" />
                  </div>
                </div>
              </div>
              <div 
              ...
              >
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <img src="https://i.postimg.cc/fLYJ04xR/enqi.jpg" alt="Yuhan's younger brother Enqi" />
                  </div>
                </div>
              </div>
              <div 
              ...
              >
                <div className="flip-card-inner">
                  ...
                  <div className="flip-card-back">
                    <img src="https://i.postimg.cc/7hVhmgtv/yuhan-young.jpg" alt="Child Yuhan" />
                  </div>
                </div>
              </div>
            </div>
